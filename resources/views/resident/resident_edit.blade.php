...
<div class="row justify-content-center">
  <div class="col-12 col-xl-9">
    ...
    <div class="top-banner">
      ...
      <h5 class="text-white mb-1 font-weight-bold" style="direction:rtl;">ویرایش ساکن</h5>
      <p class="mb-0" style="color:rgba(255,255,255,.75);font-size:13px;direction:rtl;">لطفاً اطلاعات ساکن را با دقت پُر کنید</p>
    </div>

    <div class="form-outer">
      <form action="{{ route('resident.update', ['id' => $resident->id]) }}" method="POST">
        @csrf
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="finput" name="resident_code" placeholder="کد ساکن" value="{{ $resident->resident_code }}">
          </div>
          <div class="col-md-6 mb-3">
            <label class="flabel"><i class="la la-user"></i> نام کامل <span class="required-star">*</span></label>
            <input type="text" class="finput" name="name" placeholder="نام و تخلص" value="{{ $resident->name }}">
          </div>
          <div class="col-md-6 mb-3">
            <label class="flabel"><i class="la la-male"></i> نام پدر <span class="required-star">*</span></label>
            <input type="text" class="finput" name="father_name" placeholder="نام پدر" value="{{ $resident->father_name }}">
          </div>
          <div class="col-md-6 mb-3">
            <label class="flabel"><i class="la la-phone"></i> شماره تلیفون <span class="required-star">*</span></label>
            <input type="text" class="finput" name="phone_number" placeholder="07xx-xxx-xxxx" value="{{ $resident->phone_number }}">
          </div>
          <div class="col-md-6 mb-3">
            <label class="flabel"><i class="la la-map-marker"></i> شهر / ولایت</label>
            <input type="text" class="finput" name="city_name" placeholder="نام شهر یا ولایت" value="{{ $resident->city_name }}">
          </div>
          <div class="col-md-6 mb-3">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="finput" name="occupation" placeholder="عنوان شغلی" value="{{ $resident->occupation }}">
          </div>
          <div class="col-md-6 mb-3">
            <label class="flabel"><i class="la la-phone-square"></i> شماره محل کار</label>
            <input type="text" class="finput" name="work_phone" placeholder="شماره تلیفون دفتر" value="{{ $resident->work_phone }}">
          </div>
          <div class="col-12 mb-0">
            <label class="flabel"><i class="la la-map-pin"></i> موقعیت شغل</label>
            <input type="text" class="finput" name="occupation_location" placeholder="آدرس کامل محل کار" value="{{ $resident->occupation_location }}">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="finput" name="guarantor_name" placeholder="نام و تخلص ضامن" value="{{ $resident->guarantor_name }}">
          </div>
          <div class="col-md-6 mb-3">
            <label class="flabel"><i class="la la-male"></i> نام پدر ضامن <span class="required-star">*</span></label>
            <input type="text" class="finput" name="guarantor_father_name" placeholder="نام پدر ضامن" value="{{ $resident->guarantor_father_name }}">
          </div>
          <div class="col-md-6 mb-3">
            <label class="flabel"><i class="la la-phone"></i> شماره تلیفون ضامن <span class="required-star">*</span></label>
            <input type="text" class="finput" name="guarantor_phone" placeholder="07xx-xxx-xxxx" value="{{ $resident->guarantor_phone }}">
          </div>
          <div class="col-md-6 mb-0">
            <label class="flabel"><i class="la la-briefcase"></i>  شغل ضامن</label>
            <input type="text" class="finput" name="guarantor_occupation" placeholder="شغل ضامن" value="{{ $resident->guarantor_occupation }}">
          </div>
          <div class="col-md-6 mb-0">
            <label class="flabel"><i class="la la-briefcase"></i> موقعیت شغلی ضامن</label>
            <input type="text" class="finput" name="guarantor_occupation_location" placeholder="عنوان یا موقعیت شغلی ضامن" value="{{ $resident->guarantor_occupation_location }}">
          </div>
        </div>
