                ...
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="finput" name="code" placeholder="کد ساکن">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="flabel"><i class="la la-phone"></i> شماره تلیفون <span
                                    class="required-star">*</span></label>
                            <input type="text" class="finput" name="number" placeholder="07xx-xxx-xxxx">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="flabel"><i class="la la-user"></i> ایمیل<span
                                    class="required-star">*</span></label>
                            <input type="email" class="finput" name="email" placeholder="ایمیل">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="flabel"><i class="la la-user"></i> نام کاربری <span
                                    class="required-star">*</span></label>
                            <input type="text" class="finput" name="username" placeholder="نام کاربری">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="flabel"><i class="la la-user"></i> رمز عبور <span
                                    class="required-star">*</span></label>
                            <input type="password" class="finput" name="password" placeholder="رمز عبور">
                        </div>
                        <div class="col-md-6 mb-3">
