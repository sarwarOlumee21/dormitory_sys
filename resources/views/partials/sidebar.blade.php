      ...
      @if($isRegularUser)
        ...
        <li class="{{ request()->routeIs('mealplan') ? 'active' : '' }}">
          <a href="{{ route('mealplan') }}">
            ...
            <span class="menu-title">تقسیم اوقات آشپزخانه</span>
          </a>
        </li>
      @else
        <li class="{{ request()->routeIs('home') ? 'active' : '' }}">
        ...
        <li class="nav-item {{ request()->routeIs('maintenance.*') ? 'active open' : '' }}">
          ...
          <ul class="menu-content">
            <li class="{{ request()->routeIs('maintenance.request') ? 'active' : '' }}">
              <a href="{{ route('maintenance.request') }}">ثبت درخواست</a>
            </li>
            <li class="{{ request()->routeIs('maintenance.list') ? 'active' : '' }}">
              <a href="{{ route('maintenance.list') }}">لیست درخواست‌ها</a>
            </li>
            <li class="{{ request()->routeIs('maintenance.requestType') ? 'active' : '' }}">
              <a href="{{ route('maintenance.requestType') }}"> ثبت نوعیت درخواست </a>
            </li>
          </ul>
        </li>
